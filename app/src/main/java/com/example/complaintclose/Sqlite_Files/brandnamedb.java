...
public class brandnamedb extends SQLiteOpenHelper {

    private static final String DATABASE_NAME = "DBdropdowndata";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "brandtable";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_PARTYNAME = "brandname";

    public brandnamedb(Context context) {
    ...
    public String insertdata(String partyname) {
        ...
        contentValues.put(COLUMN_PARTYNAME, partyname);                                                          //Inserts  data into sqllite database
