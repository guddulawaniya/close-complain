...
public class Insertdata_statename_sqlite {
    Context context;
    statenamedb databaseManager;

    public Insertdata_statename_sqlite(Context context) {
    ...
    public void insertdatatable() {
        ...
        databaseManager = new statenamedb(context);
        String RegistrationURL = config_file.Base_url + "gatestate.php";
