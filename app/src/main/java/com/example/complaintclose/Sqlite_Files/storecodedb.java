...
public class storecodedb extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "DBdropdowndata";
    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "storecodetable";
    public static final String COLUMN_ID = "id";
    public static final String COLUMN_PARTYNAME = "storecode";

    public storecodedb(Context context) {
